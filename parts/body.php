                    ...
                    <div class="feature-box text-center">
                        <div class="feature-header">
                            <div class="feature-icon">
                                ...
                                <i><img src="assets/img/sign.png" alt=""></i>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="feature-box text-center">
                        <div class="feature-header">
                            <div class="feature-icon">
                                <span class="circle"></span>
                                <i><img src="assets/img/collaborateF.png" alt=""></i>
                            </div>
                            <div class="feature-cont">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="feature-box text-center">
                        <div class="feature-header">
                            ...
                            <div class="feature-icon">
                                <span class="circle"></span>
                                <i><img src="assets/img/improveF.png" alt=""></i>
                            </div>
                            <div class="feature-cont">
                ...
                <div class="course-box">
                    <div class="product">
                        <div class="product-img">
                            <a href="profile.html">
                                <img class="img-fluid" alt="" src="assets/img/1.jpg" width="600" height="300">
                            </a>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="large-col">
                            <a href="search.html" class="large-col-image">
                                <div class="image-col-merge">
                                    <img src="assets/img/15F.jpg" alt="">
                                    <div class="text-col">
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <div class="large-col">
                            <a href="search.html" class="large-col-image">
                                <div class="image-col-merge">
                                    <img src="assets/img/11F.jpg" alt="">
                                    <div class="text-col">
                                        <h5>Ui designer</h5>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <div class="large-col">
                            <a href="search.html" class="large-col-image">
                                <div class="image-col-merge">
                                    <img src="assets/img/13F.jpg" alt="">
                                    <div class="text-col">
                                        <h5>IT Security</h5>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row blog-grid-row">
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="assets/img/13.jpg" alt="Post Image"></a>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="assets/img/Dunia-2.jpg" alt="Post Image"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="assets/img/Base-30.jpg" alt="Post Image"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                ...
                <div class="col-md-6 col-lg-3 col-sm-12">
                    ...
                    <div class="blog grid-blog">
                        <div class="blog-image">
                            <a href="blog-details.html"><img class="img-fluid" src="assets/img/16.jpg" alt="Post Image"></a>
                        </div>
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
